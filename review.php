...
require('_include/header.html');?>
    <div class="container">
        ...
        <div class="pre_2 col_8">
            <form class="form" action='_functions/doExpressCheckout.php' METHOD='POST'>
				<h1 id="mainTitle">Customer Data Returned from 'GetExpressCheckoutDetails' API Call:</h1>
				<div class="content">
<?php
/*==================================================================
...
if ( $token != "" )
{
	...
	require_once ("_functions/paypalfunctions.php");
	...
	*/
	...
	foreach	($resArray as $x) {
        echo $x . "<br />";
    }
?>
<br />
  <input style="width:50%;"type="submit" name="doExpressCheckoutBtn" value="Confirm Payment"></input>             
</form> 
        </div>	
    </div>
</div>
